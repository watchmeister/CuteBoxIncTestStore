...
theme.Product = (function() {
  ...
  Product.prototype = Object.assign({}, Product.prototype, {
    ...
    _updateSKU: function(evt) {
      ...
      if (!sku) return;
      // Added "SKU: " Before the variant.sku to show on the product page.
...
// Start ===  JJB Custom Code for Sticky Header  ===
function headerSize() {
...
// End ===  JJB Custom Code for Sticky Header  ===  
  
  
  //==========================================================================
  
  
// Testing Code to hide Announcment banner on scroll
...
window.onscroll = function() {
  ...
  if (prevScrollpos > currentScrollPos || currentScrollPos == 0)) {
    document.getElementByClassName("announcement-bar").style.top = "0";
    prevScrollpos = currentScrollPos;
  } else {
    document.getElementByClassName("announcement-bar").style.top = "-50px";
  }
  prevScrollpos = currentScrollPos;
}
